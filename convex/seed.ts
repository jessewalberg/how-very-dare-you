...
const SEED_TITLES = [
  {
    ...
    videoAnalysis: {
      youtubeVideoId: "seed-pawpatrol",
      analyzedAt: 1708905600000,
      cutsPerMinute: 14.2,
      avgCutDuration: 4.2,
      avgSaturation: 115.3,
      avgBrightness: 168.7,
      brightnessVariance: 28.4,
      flashCount: 1,
      trailerBiasCorrected: false,
    },
    confidence: 0.85,
    notes:
  ...
  },
  {
    ...
    videoAnalysis: {
      youtubeVideoId: "seed-cocomelon",
      analyzedAt: 1708905600000,
      cutsPerMinute: 28.4,
      avgCutDuration: 2.1,
      avgSaturation: 195.6,
      avgBrightness: 205.3,
      brightnessVariance: 52.1,
      flashCount: 8,
      trailerBiasCorrected: true,
    },
    confidence: 0.9,
    notes:
  ...
  },
  {
    ...
    videoAnalysis: {
      youtubeVideoId: "seed-bluey",
      analyzedAt: 1708905600000,
      cutsPerMinute: 7.1,
      avgCutDuration: 8.4,
      avgSaturation: 82.4,
      avgBrightness: 145.2,
      brightnessVariance: 15.3,
      flashCount: 0,
      trailerBiasCorrected: true,
    },
    confidence: 0.85,
  ...
  },
  {
    ...
    videoAnalysis: {
      youtubeVideoId: "seed-mario",
      analyzedAt: 1708905600000,
      cutsPerMinute: 18.3,
      avgCutDuration: 3.3,
      avgSaturation: 172.8,
      avgBrightness: 188.4,
      brightnessVariance: 38.2,
      flashCount: 3,
      trailerBiasCorrected: false,
    },
    confidence: 0.9,
  ...
  },
  {
    ...
    videoAnalysis: {
      youtubeVideoId: "seed-frozen2",
      analyzedAt: 1708905600000,
      cutsPerMinute: 12.1,
      avgCutDuration: 5.0,
      avgSaturation: 95.2,
      avgBrightness: 155.8,
      brightnessVariance: 22.7,
      flashCount: 1,
      trailerBiasCorrected: false,
    },
    confidence: 0.9,
  ...
  },
  {
    ...
    videoAnalysis: {
      youtubeVideoId: "seed-lightyear",
      analyzedAt: 1708905600000,
      cutsPerMinute: 15.4,
      avgCutDuration: 3.9,
      avgSaturation: 120.1,
      avgBrightness: 162.3,
      brightnessVariance: 30.5,
      flashCount: 2,
      trailerBiasCorrected: false,
    },
    confidence: 0.95,
  ...
  },
  {
    ...
    videoAnalysis: {
      youtubeVideoId: "seed-strangeworld",
      analyzedAt: 1708905600000,
      cutsPerMinute: 16.8,
      avgCutDuration: 3.6,
      avgSaturation: 185.4,
      avgBrightness: 178.9,
      brightnessVariance: 41.3,
      flashCount: 4,
      trailerBiasCorrected: false,
    },
    confidence: 0.95,
  ...
  },
  {
    ...
    videoAnalysis: {
      youtubeVideoId: "seed-turningred",
      analyzedAt: 1708905600000,
      cutsPerMinute: 13.5,
      avgCutDuration: 4.4,
      avgSaturation: 128.7,
      avgBrightness: 165.1,
      brightnessVariance: 26.8,
      flashCount: 1,
      trailerBiasCorrected: false,
    },
    confidence: 0.9,
  ...
  },
  {
    ...
    videoAnalysis: {
      youtubeVideoId: "seed-elemental",
      analyzedAt: 1708905600000,
      cutsPerMinute: 11.2,
      avgCutDuration: 5.4,
      avgSaturation: 148.3,
      avgBrightness: 175.6,
      brightnessVariance: 24.1,
      flashCount: 1,
      trailerBiasCorrected: false,
    },
    confidence: 0.95,
  ...
  },
  {
    ...
    videoAnalysis: {
      youtubeVideoId: "seed-wish",
      analyzedAt: 1708905600000,
      cutsPerMinute: 12.4,
      avgCutDuration: 4.8,
      avgSaturation: 118.9,
      avgBrightness: 162.7,
      brightnessVariance: 25.3,
      flashCount: 2,
      trailerBiasCorrected: false,
    },
    confidence: 0.85,
